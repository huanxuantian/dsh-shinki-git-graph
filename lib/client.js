...
.sgg-commit-input{flex:1;min-width:0;background:var(--dsw-alias-bg-layer-2,transparent);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.1));border-radius:6px;padding:4px 6px;font-size:12px;color:var(--dsw-alias-label-primary,#e6edf3);outline:none}
