...
.sgg-detail{border-top:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.1));max-height:33%;display:flex;flex-direction:column;overflow:hidden;background:var(--dsw-alias-bg-layer-1,rgba(0,0,0,.15))}
